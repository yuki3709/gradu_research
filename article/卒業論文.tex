...
参考書~\cite{b1}に記述されている見本のプログラムから評価基準を抽出できるように評価基準生成システムを作成した。
...
キーボードから入力された整数が，1の場合とそれ以外の場合で違う文章を表示させる。
\end{itembox}
...
受け取った２つの値の合計値を返す関数int sum(int x, int y)を作成し，キーボードから入力した2つ整数の合計を表示する。
\end{itembox}
